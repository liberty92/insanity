...
<body>
	...
	<div class="noti">BK SECURITIES - LIBERTY LAB © 2016 - ALL FOR
		THE LIBERATION</div>
	</div>
	<div style="position: fixed; z-index: -99; width: 100%; height: 100%">
		<iframe frameborder="0" height="100%" width="100%"
			src="https://youtube.com/embed/KT_C_X3oEX0?start=4&autoplay=1&controls=0&showinfo=0&autohide=1&allowfullscreen">
		</iframe>
	</div>
