...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Sau",sPrevious:"Trước"},sEmptyTable:"Không có dữ liệu",sInfo:"Hiển thị _START_ đến _END_ trong _TOTAL_ bản ghi",sInfoEmpty:"Hiển thị 0 đến 0 trong 0 bản ghi",
